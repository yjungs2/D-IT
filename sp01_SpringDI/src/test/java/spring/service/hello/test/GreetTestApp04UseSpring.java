...
public class GreetTestApp04UseSpring {
	...
	public static void main(String[] args) {
		...
		//greet.sayMessage(); // spring.service.hello.Greet==>null
		
		//Greet greet = (Greet)factory.getBean("greet2");
		//greet.sayMessage(); // spring.service.hello.Greet==>Hello Spring~~
		
		//Greet greet = (Greet)factory.getBean("greet3");
		//greet.sayMessage(); // spring.service.hello.Greet==>Hello Spring3~~
		
		//Greet greet = (Greet)factory.getBean("greet4");
		//greet.sayMessage(); // spring.service.hello.Greet==>Hello Spring4~~ setter 값 주입 결과 출력
		
		//Greet greet = (Greet)factory.getBean("greet5");
		//greet.sayMessage(); // spring.service.hello.Greet==>스프링 설정문서 만들기
